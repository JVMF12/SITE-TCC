    ...
    <div>
      ...
      <section className='border-solid border-bgCaixa border-[0.225rem]  mx-box mb-bottom mt-top rounded-customPedro md:flex md:w-[50rem] sm:max-w-[47rem]'>
        <div className='flex flex-col items-center md:justify-center md:px-inline md:w-[15rem]'>
          ...
          <h2 className='text-titulo font-semibold pt-top text-xl font-subtitulo mb-2'>Arduino</h2>
        </div>
      ...
      <section className='border-solid border-bgCaixa border-[0.225rem] mx-box mb-bottom mt-top rounded-customPedro md:flex md:w-[50rem] sm:max-w-[47rem]'>
        <div className='flex flex-col items-center md:justify-center md:px-inline md:w-[15rem]'>
          ...
          <h2 className='text-titulo font-semibold pt-top text-xl md:text-center font-subtitulo mb-2'>Célula de carga</h2>
        </div>
        <div className='bg-bgCaixa rounded-b-[.92rem] flex flex-col items-center md:rounded-r-[.92rem] md:rounded-l-none md:flex md:flex-col md:justify-center md:max-w-[32.5rem] md:py-desk md:px-desk text-white'>
      ...
      <section className='border-solid border-bgCaixa border-[0.225rem] mx-box mb-bottom mt-top rounded-customPedro md:flex md:w-[50rem] sm:max-w-[47rem]'>
        <div className='flex flex-col items-center md:justify-center md:px-inline md:w-[15rem]'>
          ...
          <h2 className='text-titulo font-semibold pt-top text-xl md:text-center font-subtitulo mb-2'>Módulo HX711</h2>
        </div>
        <div className='bg-bgCaixa rounded-b-[.92rem] flex flex-col items-center md:rounded-r-[.92rem] md:rounded-l-none md:flex md:flex-col md:justify-center md:max-w-[32.5rem] md:py-desk md:px-desk text-white'>
      ...
      <section className='border-solid border-bgCaixa border-[0.225rem] mx-box mb-bottom mt-top rounded-customPedro md:flex md:w-[50rem] sm:max-w-[47rem]'>
        <div className='flex flex-col items-center md:justify-center md:px-inline md:w-[15rem]'>
          ...
          <h2 className='text-titulo font-semibold pt-top text-xl md:text-center font-subtitulo mb-2'>Protoboard</h2>
        </div>
        <div className='bg-bgCaixa rounded-b-[.92rem] flex flex-col items-center md:rounded-r-[.92rem] md:rounded-l-none md:flex md:flex-col md:justify-center md:max-w-[32.5rem] md:py-desk md:px-desk text-white'>
      ...
      <section className='border-solid border-bgCaixa border-[0.225rem] mx-box mb-bottom mt-top rounded-customPedro md:flex md:w-[50rem] sm:max-w-[47rem]'>
        <div className='flex flex-col items-center md:justify-center md:px-inline md:w-[15rem]'>
          ...
          <h2 className='text-titulo font-semibold pt-top text-xl md:text-center font-subtitulo mb-2'>Workplate</h2>
        </div>
        <div className='bg-bgCaixa rounded-b-[.92rem] flex flex-col items-center md:rounded-r-[.92rem] md:rounded-l-none md:flex md:flex-col md:justify-center md:max-w-[32.5rem] md:py-desk md:px-desk text-white'>
      ...
      <section className='border-solid border-bgCaixa border-[0.225rem] mx-box mt-top rounded-customPedro md:flex md:w-[50rem] sm:max-w-[47rem] md:mb-bottom'>
        <div className='flex flex-col items-center md:justify-center md:px-inline md:w-[15rem]'>
          ...
          <h2 className='text-titulo font-semibold pt-top text-xl md:text-center font-subtitulo mb-2'>Display LCD</h2>
        </div>
        <div className='bg-bgCaixa rounded-b-[.92rem] flex flex-col items-center md:rounded-r-[.92rem] md:rounded-l-none md:flex md:flex-col md:justify-center md:max-w-[32.5rem] md:py-desk md:px-desk text-white'>
