    ...
    <div className='bg-fundo bg-repeat bg-[length:100vh] min-h-screen '>
        ...
        <section className='flex justify-center items-center font-barlow md:ml-7 mb-[5.5rem]'>
            <div className='flex flex-col  space-y-2 justify-center items-center'>
                <h1 className='text-botaoSelecionado text-[2.55rem] md:text-7xl lg:text-7xl font-[800] tracking-ultraWidest justify-center'>NutriScale</h1>
                <h3 className='text-white mt-2 text-[0.9rem] font-poppins md:text-2xl'>A balança inteligente para controle alimentar</h3>
            </div>
         </section>

         <div className='"my-6 p-6 md:mx-auto md:flex  md:items-center md:max-w-[60rem] '>
               <img src={Balanca} alt="Ilustração de uma balança de alimentos" className='mx-auto mb-3 md:w-150 md:h-100 max-w-150 max-h-80 md:mr-16'/>
               <div className='text-justify text-white'>
                    <div className='flex p-[1rem]'>
                        <div className='flex flex-col justify-center'>
                            <img src={Topico} alt="" className='md:h-[4rem] md:w-[0.5rem] h-[7rem] w-[0.8rem]'/>
                        </div> 
                        <p className='pl-[1rem]'>Descubra uma nova maneira de monitorar sua saúde com essa balança inteligente conectada ao aplicativo exclusivo, oferecendo análises precisas e insights personalizados em tempo real.</p>
                    </div>
                    <div className='flex p-[1rem]'>
                        <div className='flex flex-col justify-center'>
                            <img src={Topico} alt="" className='md:h-[4rem] md:w-[0.5rem] h-[6rem] w-[0.8rem]'/>
                        </div> 
                        <p className='pl-[1rem]'>Seja para controlar calorias, analisar nutrientes ou simplesmente manter o equilíbrio, essa ferramenta é a melhor aliada para seu bem-estar diário.</p>
                    </div>
               </div>
         </div>
            ...
            <div className='mx-4 mb-10'>
                <div className='px-2 text-justify md:flex md:flex-col md:items-center'>
                    <div className='md:flex gap-10 my-10'>
                        <div>
                            <h3 className='flex justify-center text-titulo font-semibold text-center text-2xl my-[1.5rem]  font-subtitulo'>Alimentação saudável</h3>
                       ...
                       <div className='md:flex md:flex-col md:mt-6'>
                        ...
                        <div>
                            <h3 className='flex justify-center text-titulo font-semibold text-center text-2xl my-[1.5rem] font-subtitulo'>Variedade</h3>
                    ...
                    <div>
                        <h3 className='flex justify-center text-titulo font-semibold text-center text-2xl my-[1.5rem] font-subtitulo'>Praticidade</h3>
