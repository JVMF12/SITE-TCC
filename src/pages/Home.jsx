...
export default function Home() {
  return (
    <div className='bg-fundo bg-repeat min-h-screen'>
        <HeaderHome/>
        ...
        <section className='flex justify-center items-center font-barlow md:ml-7 mb-[5.5rem]'>
            <div className='flex flex-col  space-y-2 justify-center items-center'>
                <h1 className='text-botaoSelecionado text-[2.55rem] md:text-7xl lg:text-8xl font-[800] tracking-ultraWidest justify-center  '>NutriScale</h1>
